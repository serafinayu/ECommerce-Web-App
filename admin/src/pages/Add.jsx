    ...
    return (
        <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'>
            ...
            <div className='w-full'>
                ...
                <input onChange={(e) => setName(e.target.value)} value={name} className="w-full max-w-[500px] px-3 py-2 placeholder-gray-300" type="text" placeholder='Type here' required />
            </div>

            <div className='w-full'>
                <p className='mb-2'>Product Description</p>
                <textarea onChange={(e) => setDescription(e.target.value)} value={description} className="w-full max-w-[500px] px-3 py-2 placeholder-gray-300" type="text" placeholder='Write here' required />
            </div>
            ...
            <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8'>
                ...
                <div>
                    ...
                    <input onChange={(e) => setPrice(e.target.value)} className='w-full px-3 py-2 sm:w-[120px] placeholder-gray-300' type="number" placeholder="25" />
                </div>
