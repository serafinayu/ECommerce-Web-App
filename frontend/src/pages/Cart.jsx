    ...
    <div className='border-t pt-14 border-gray-300'>
      ...
      <div>
        {cartData.map((item, index) => {
          ...
          return (
            <div key={index} className='py-4 border-t border-b border-gray-300 text-gray-700 grid grid-cols-[4fr+-.5fr+0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4'>
